/*
 * Code Added by Gareth on Stack Overflow (https://stackoverflow.com/questions/20482338/simulate-keyboard-input-in-c-sharp)
 * All code from SO is within the "Original code from SO" region
 * Some keycodes commented out
*/
...
namespace Xterra2Input
{
    class SendInputs
    {
        #region Modified/Added Code
        public void SendKeyInput(ScanCodeShort key)
        {
        ...
        public void SendKeyUpInput(ScanCodeShort key)
        {
            INPUT[] Inputs = new INPUT[1];
            INPUT Input = new INPUT();
